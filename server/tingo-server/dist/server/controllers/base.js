...
class BaseCtrl {
    constructor() {
        ...
        this.getAll = (req, res) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const docs = yield this.model.find({}).exec();
        ...
        this.count = (req, res) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const count = yield this.model.count().exec();
        ...
        this.insert = (req, res) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const obj = yield new this.model(req.body).save().exec();
        ...
        this.get = (req, res) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const obj = yield this.model.findOne({ _id: req.params.id }).exec();
        ...
        this.update = (req, res) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                yield this.model.findOneAndUpdate({ _id: req.params.id }, req.body).exec();
                res.sendStatus(200);
            }
            catch (err) {
                return res.status(400).json({ error: err.message });
        ...
        this.delete = (req, res) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                yield this.model.findOneAndRemove({ _id: req.params.id }).exec();
                res.sendStatus(200);
            }
            catch (err) {
                return res.status(400).json({ error: err.message });
